                            ...
                            <div class="col-md-9">
                                <div class="mb-3">
                                    ...
                                    <input name="name" id="name" type="text" class="form-control "
                                        value="{{ old('name', $row->name) }}" placeholder="vd: Tiểu thuyết">
                                    @if ($errors->has('name'))
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="metadesc" id="metadesc" cols="10" rows="2" class="form-control "
                                        placeholder="vd: là một thể loại văn xuôi có hư cấu,...">{{ old('metadesc', $row->metadesc) }}</textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="metakey" id="metakey" cols="10" rows="2" class="form-control "
                                        placeholder="vd: harry potter">{{ old('metakey', $row->metakey) }}</textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    @if ($row->image)
                                        <img id="previewImg" class="mt-1" width="30%"
                                            src="{{ asset('images/category/' . $row->image) }}" alt="">
                                    @else
                                        <img id="previewImg" class="mt-1" width="30%"
