...
Route::post('bai-viet', [SiteController::class, 'post'])->name('site.post');
Route::get('lien-he', [SiteContactController::class, 'index'])->name('site.contact');
Route::post('tim-kiem/{keyword}', [SearchController::class, 'index'])->name('site.search');
Route::post('gio-hang', [CartController::class, 'index'])->name('site.cart');
Route::post('gio-hang/addcart}', [CartController::class, 'addcart'])->name('site.cart.addcart');
