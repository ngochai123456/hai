...
public function update(UpdateUserRequest $request,$id)
    ...
    {                                         
        $title ='Danh sách thành viên bị xoá';                                                                                                             #$title...
    ...
    public function status($id)
    {
        ...
        $row ->save();
        return redirect()->route('user.index')->with('message', ['type' => 'success', 'mgs' => 'Thay đổi trạng thái thành công']);
    }
    ...
    public function delete($id)
    {
        ...
        $row ->save();
        return redirect()->route('user.index')->with('message', ['type' => 'success', 'mgs' => 'Xoá vào thùng rác thành công']);
    }
    ...
    $row = User::find($id);
        ...
        $row ->save();
        return redirect()->route('user.index')->with('message', ['type' => 'success', 'mgs' => 'Khôi phục thành công']);
    }
}
?>
